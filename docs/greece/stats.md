...
## Транзит
### Опыт транзита через Грецию
#### Транзит с пересадкой
Некоторые пользователи успешно осуществляли транзит через Грецию без получения визы:
##### Пример транзита с пересадкой в Афинах
- Перелет из Белграда в Ереван с пересадкой в Афинах
- Длительность пересадки около 5-12 часов
- При регистрации на рейс потребовали предоставить обратный билет
- Рекомендуется приобретать билет с возможностью изменения даты
#### Особенности транзита
- При транзите через Афины необходимо иметь обратный билет
- Рекомендуется использовать авиалинии Aegean Airlines
- Важно уточнять условия транзита заранее
### Новые правила для транзита
#### Дополнительные формы
На македонской границе введена новая форма для граждан РФ, Белоруссии и Украины:
- Заполнение формы с указанием персональных данных
- Указание цели въезда (транзит)
- Предоставление формы пограничным службам
#### Рекомендации по заполнению формы
- Указывать маршрут следования
- Подробно описывать цель поездки
- Предоставлять полную информацию о транзите
### Мультивиза для транзита
#### Особенности получения
- При поездке на автомобиле через Македонию рекомендуется получать мультивизу
- Мультивиза позволяет свободно пересекать границы
- Консульство может выдавать мультивизу под конкретный маршрут
### Ограничения и особенности
#### Визовый режим
- Первая виза обычно выдается как однократная
- Для транзита через Македонию необходимо специальное оформление
