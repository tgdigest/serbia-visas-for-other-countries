...
### Блокирует ли консульство IP-адрес при частой проверке слотов на сайте?
...
### Какой номер нужно указывать при бронировании слота (Personal num, JMBG, номер боравака)?
...
### Можно ли взять один слот на двоих взрослых?
...
### Приходят ли письма о подтверждении записи на подачу документов в консульство Венгрии?
...
### Что вводить в поле Visa No / номер визы при записи на подачу документов?
...
### Что означает 'ловля слота' и что это за дата?
